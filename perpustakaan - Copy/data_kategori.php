                            ...
                            <?php
                                ...
                                while ($d = mysqli_fetch_array($data) ) : ?>
                                    <tr>
                                        ...
                                        <td><a href="edit_kategori.php?Id=<?php echo $d['Id_kategori']; ?>" class="btn btn-warning">Edit</a>  <a href="hapus_kategori.php?Id=<?php echo $d['Id_kategori']; ?>" class="btn btn-danger">Hapus</a> </td>
                                    </tr>
                                <?php endwhile; ?>
                        </table>
                    </div>
